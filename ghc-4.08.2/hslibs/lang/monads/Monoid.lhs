...
default will be used, but is included in the class definition so that
optimized version of \haskell:expr{mconcat} can for specific types.
...
The Monoid instance for functions.
\begin{code}
