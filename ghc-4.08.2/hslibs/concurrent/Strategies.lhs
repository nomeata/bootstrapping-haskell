Time-stamp: <Thu Jan 13 2000 19:18:42 Stardate: [-30]4199.02 hwloidl>
$Id: Strategies.lhs,v 1.1 2000/01/14 13:34:32 hwloidl Exp $
...
Author:    $Author: hwloidl $
Date:      $Date: 2000/01/14 13:34:32 $
...
"Algorithm + Strategy = Parallelism", P.W. Trinder, K. Hammond, H-W. Loidl,
S.L. Peyton Jones to appear in Journal of Functional Programming 8(1),
January 1998.

This module supports both Haskell 1.2 and Haskell 1.4 (based on the 
__HASKELL1__ CPP variable). It could be rewritten to use constructor classes 
in a Haskell 1.4 setup.
...
>#endif
>#if (__HASKELL1__>=4)
> import qualified Parallel -- NB: Must use MyParallel.lhs for the moment!!
>#else
...
> strategy_id = "$Id: Strategies.lhs,v 1.1 2000/01/14 13:34:32 hwloidl Exp $"
