module XmlCombinators
  ...
  , mkElem, mkElemAttr, literal, replaceTag, replaceAttrs
  , (?>), ThenElse(..)
  , LabelFilter
...
f `when` g       = g ?> f :> keep
g `guards` f     = g ?> f :> none	-- = f `o` (keep `with_` g)
