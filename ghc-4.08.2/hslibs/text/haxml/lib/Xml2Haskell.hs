module Xml2Haskell
  ...
  , maybeA
  , definiteA, possibleA, fromAttrToStr, toAttrFrStr
  , str2attr, attr2str
...
maybeA :: (String->a->Maybe Attribute) -> String -> Maybe a -> Maybe Attribute
maybeA to n Nothing  = Nothing
maybeA to n (Just v) = to n v
