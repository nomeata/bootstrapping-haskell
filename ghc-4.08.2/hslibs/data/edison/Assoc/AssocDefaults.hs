...
subsetUsingMember :: FiniteMap m k => m k a -> m k b -> Bool
subsetUsingMember m1 m2 = foldWithKey mem True m1
  where mem k _ b = member m2 k && b

subsetEqUsingSubset :: FiniteMapX m k => m k a -> m k b -> Bool
subsetEqUsingSubset m1 m2 = subset m1 m2 && subset m2 m1
